    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonVerifyNumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // DEMO MODE: Check if demo OTP
                if (verificationCode.equals("demo_code") && otp.equals("123456")) {
                    Toast.makeText(PhoneVerificationActivity.this,
                            "DEMO MODE: Login Successful!", Toast.LENGTH_SHORT).show();
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (creationTimestamp == lastSignInTimestamp) {
                                // do create new user
                                Toast.makeText(PhoneVerificationActivity.this, "Create your profile to continue",
                                        Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(PhoneVerificationActivity.this, AddProfileActivity.class));
                                finish();
                            } else {
                                // user is exists, just do login
                                Toast.makeText(PhoneVerificationActivity.this, " Welcome Back ", Toast.LENGTH_SHORT)
                                        .show();
                                Intent intent = new Intent(PhoneVerificationActivity.this, MainActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(intent);
 ...
 * Toast.makeText(VerifyPhoneActivity.this,"Please enter A Valid Code ",Toast.
 * LENGTH_SHORT).show();
 ...
 * if(task.isSuccessful()) {
 * // Intent intent = new
 * Intent(VerifyPhoneActivity.this,AddProfileActivity.class);
 * // intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK |
 * Intent.FLAG_ACTIVITY_CLEAR_TASK);
 * // startActivity(intent);
 * startActivity(new Intent(VerifyPhoneActivity.this,AddProfileActivity.class));
 * } else {
 * Toast.makeText(VerifyPhoneActivity.this,task.getException().toString(),Toast.
 * LENGTH_LONG).show();
 * }
 * }
 * });
