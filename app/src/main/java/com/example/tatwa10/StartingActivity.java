...
public class StartingActivity extends AppCompatActivity {
    ...
    private void continueClicked() {
        if (isDoctor) {
            // DIRECT ACCESS: Skip verification, go directly to Doctor dashboard
            Intent intent = new Intent(StartingActivity.this, DoctorMainActivity.class);
            intent.putExtra("name", "Dr Adiveppa Hosangadi"); // Default doctor
            startActivity(intent);
            finish();
        } else {
            // DIRECT ACCESS: Skip verification, go directly to Patient dashboard
    ...
    private void patientClicked() {
        isDoctor = false;
        buttonPatient.setBackground(ContextCompat.getDrawable(this, R.drawable.custom_button_border_2));
        buttonDoctor.setBackground(ContextCompat.getDrawable(this, R.drawable.custom_button_border_3));
    }

    private void doctorClicked() {
        isDoctor = true;
        buttonPatient.setBackground(ContextCompat.getDrawable(this, R.drawable.custom_button_border_3));
        buttonDoctor.setBackground(ContextCompat.getDrawable(this, R.drawable.custom_button_border_2));
    }

    @Override
    protected void onStart() {
        super.onStart();
        // DIRECT ACCESS MODE: Removed auto-login checks
        // Users will always see the selection screen
        /*
