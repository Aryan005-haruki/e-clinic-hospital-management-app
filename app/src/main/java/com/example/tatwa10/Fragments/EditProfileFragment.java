...
public class EditProfileFragment extends Fragment {
    ...
    private void getReference() {
        ...
        collectionReference.whereEqualTo("phone", phone).get()
    ...
    private void saveProfile() {
        ...
        final DocumentReference documentReference = FirebaseFirestore.getInstance().collection("Patients")
                .document(documentId);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == GALLERY_REQUEST_CODE && resultCode == getActivity().RESULT_OK && data != null) {
            ...
            if (imageUri != null) {
                ...
                Toast.makeText(getContext(), "Failed to get image. Please try again.", Toast.LENGTH_SHORT).show();
            }
        } else {
