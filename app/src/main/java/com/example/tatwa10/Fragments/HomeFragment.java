...
public class HomeFragment extends Fragment {
    ...
    private Button buttonHealthPrecautions;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        buttonHealthPrecautions = view.findViewById(R.id.button_health_precautions);
        ...
        buttonFindDoctors.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getParentFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new FindDoctorsFragment()).addToBackStack(null).commit();
            }
        });
        ...
        buttonBookAppointment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getParentFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new BookAppointmentFragment()).addToBackStack(null).commit();
            }
        });
        ...
        buttonPrescriptions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getParentFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new PrescriptionFragment()).addToBackStack(null).commit();
            }
        });

        buttonHealthPrecautions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getParentFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new HealthPrecautionFragment()).addToBackStack(null).commit();
            }
        });
        ...
        buttonCallAmbulance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getParentFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new CallAmbulanceFragment()).addToBackStack(null).commit();
            }
        });
